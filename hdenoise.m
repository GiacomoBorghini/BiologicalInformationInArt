...
M1_entropy = -1 * (M1(2,1)*log(M1(2,1)) + M1(1,2)*log(M1(1,2)) + M1(2,2)*log(M1(2,2)));
M2_entropy = -1 * (M2(2,1)*log(M2(2,1)) + M2(1,2)*log(M2(1,2)) + M2(2,2)*log(M2(2,2)));
disp(M1_entropy + M2_entropy)


% figure(1);
% imagesc(w);
% colorbar;
% title("Wavelet Coefficient Data");

% figure(2);
% imagesc(M1);
% colorbar;
% title("M=1 Probability Matrix");
% 
% figure(3);
% imagesc(M2);
% colorbar;
% title("M=2 Probability Matrix");
% 
% 
% ES11 = squeeze(ES(1,1,:,:));
% ES12 = squeeze(ES(1,2,:,:));
...
% imagesc(ES11);
% colorbar;
% title("1 -> 1 Estimation Matrix");
% 
% figure(5);
% imagesc(ES12);
% colorbar;
% title("1 -> 2 Estimation Matrix");
% 
% figure(6);
% imagesc(ES21);
% colorbar;
% title("2 -> 1 Estimation Matrix");
% 
% figure(7);
% imagesc(ES22);
% colorbar;
% title("2 -> 2 Estimation Matrix");
